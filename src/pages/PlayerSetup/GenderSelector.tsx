...
export function GenderSelector({ selectedGender, onSelectGender }: GenderSelectorProps) {
  return (
    <div className={styles.genderContainer}>
      <h2 className={styles.sectionTitle}>캐릭터 성별을 선택하세요</h2>
      <div className={styles.genderButtons}>
        <div className={selectedGender === 'female' ? styles.selectedWrapper : ''}>
          <GenderButton
            gender="female"
        ...
        <div className={selectedGender === 'male' ? styles.selectedWrapper : ''}>
          <GenderButton
            gender="male"
