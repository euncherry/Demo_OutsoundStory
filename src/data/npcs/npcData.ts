...
export const npcData: Record<string, NPCData> = {
  hojun: {
    ...
    profileImage: '/assets/characters/player/female/body.png',
    bodyImage: '/assets/characters/player/female/body.png',
    voiceType: 'warm',
    themeColor: '#FF9B9B',
  },
  jihoon: {
    ...
    profileImage: '/assets/characters/npcs/jihoon/profile.png',
    bodyImage: '/assets/characters/npcs/jihoon/body.png',
    voiceType: 'soft',
    themeColor: '#9BB5FF',
  },
  dojin: {
    ...
    profileImage: '/assets/characters/npcs/dojin/profile.png',
    bodyImage: '/assets/characters/npcs/dojin/body.png',
    voiceType: 'confident',
    themeColor: '#B89BFF',
  },
  yohan: {
    ...
    profileImage: '/assets/characters/npcs/yohan/profile.png',
    bodyImage: '/assets/characters/npcs/yohan/body.png',
    voiceType: 'gentle',
    themeColor: '#9BFFB8',
  },
  kanghyuk: {
    ...
    profileImage: '/assets/characters/npcs/kanghyuk/profile.png',
    bodyImage: '/assets/characters/npcs/kanghyuk/body.png',
