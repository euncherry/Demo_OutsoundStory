    ...
    >
      ...
      <div className={styles.recordingSection}>
        <div className={styles.waveformContainer}>
          <div ref={recordingWaveformRef} className={styles.recordingWaveform} />
        </div>

        {/* 녹음 시간 표시 */}
        <div className={styles.timeDisplay}>
          <span className={styles.recordingTime}>⏱️ {formatTime(recordingTime)}</span>
        </div>
      ...
      <div className={styles.guideSection}>
        <p className={styles.guideText}>📢 마이크에 대고 명확하게 발음해주세요</p>
