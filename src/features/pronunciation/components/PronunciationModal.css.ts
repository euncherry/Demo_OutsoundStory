...
export const modalContainer = style({
  ...
  boxShadow: `
    0 20px 60px rgba(230, 220, 255, 0.3),
...
export const closeButton = style({
  ...
  ':hover': {
    ...
    boxShadow: '0 6px 20px rgba(255, 200, 220, 0.3)',
  },
...
export const standardAudioSection = style({
  ...
  boxShadow:
    '0 10px 25px rgba(230, 220, 255, 0.15), inset 0 1px 3px rgba(255, 255, 255, 0.8)',
  borderRadius: '20px',
});
...
export const playButton = style({
  ...
  ':hover': {
    ...
    boxShadow: `
      0 8px 25px rgba(230, 220, 255, 0.35),
      inset 0 1px 0 rgba(255, 255, 255, 1)
    `,
  },
...
export const startRecordButton = style({
  ...
  transition: vars.transitions.normal,
  boxShadow: `
    0 8px 25px rgba(230, 220, 255, 0.3),
    inset 0 1px 0 rgba(255, 255, 255, 0.5)
  `,
...
export const pauseButton = style({
  ...
  ':hover': {
    transform: 'translateY(-2px) scale(1.05)',
    boxShadow: '0 8px 25px rgba(200, 255, 214, 0.35)',
  },
});
