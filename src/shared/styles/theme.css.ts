...
export const vars = createThemeContract({
  colors: {
    ...
    buttonSilver: null,
    buttonHover: null,
    buttonMainSolid: null,
    buttonMainSolidHover: null,
    buttonSubSolid: null,
    buttonSubSolidHover: null,
    success: null,
    warning: null,
    error: null,
    info: null,
...
export const globalTheme = createTheme(vars, {
  colors: {
    ...
    buttonMainSolid:
      "linear-gradient(135deg, rgba(255, 255, 255, 1), rgba(230, 220, 255, 1), rgb(255, 230, 250))",

    buttonMainSolidHover: "rgba(212, 195, 255, 1)",
    buttonSubSolid:
      "linear-gradient(135deg, rgba(255, 255, 255, 1), rgb(255, 250, 200), rgb(255, 240, 180))",

    buttonSubSolidHover: "rgba(255, 240, 180, 1)",
...
export const femaleTheme = createTheme(vars, {
  colors: {
    ...
    buttonMainSolid:
      "linear-gradient(135deg, rgba(255, 255, 255, 1), rgba(255, 200, 220, 1),rgba(255, 200, 220, 1), rgba(255, 180, 200,1))",
    buttonMainSolidHover: "rgba(255, 180, 200, 1)",
    buttonSubSolid:
      "linear-gradient(135deg, rgba(255, 255, 255, 1), rgba(200, 255, 220, 1), rgba(212, 241, 238, 1))",

    buttonSubSolidHover: "rgba(168, 240, 200, 1)",
...
export const maleTheme = createTheme(vars, {
  colors: {
    ...
    buttonMainSolid:
      "linear-gradient(135deg, rgba(255, 255, 255,1), rgba(200, 230, 255, 1), rgba(220, 200, 255, 1), rgba(220, 200, 255, 1))",

    buttonMainSolidHover: "rgba(157, 206, 255, 1)",
    buttonSubSolid:
      "linear-gradient(135deg, rgba(255, 255, 255,1), rgba(180, 230, 255, 1),rgba(180, 230, 255, 1), rgba(150, 200, 255, 1))",

    buttonSubSolidHover: "rgba(127, 212, 255, 1)",
    ...
    gradient: "linear-gradient(135deg, rgb(134, 198, 250), rgb(161, 109, 250))",
